...
description: Lessons from creating Vue File Agent and Rockplate — and why the same principles apply to AI-generated code.
publishedAt: 2026-02-20
author: Safraz Razik
image: "../../../assets/blog/building-open-source-tools.svg"
tags: ["Open Source", "Vue File Agent", "Rockplate", "Engineering"]
locale: en
draft: false
featured: true
---
...
The response from users was overwhelmingly about the docs. "I understood it in five minutes." That's the goal.

## Maintenance Compounds

The first year of Vue File Agent was exciting — issues, PRs, feature requests. The second year was maintenance. The third year was the real test: would I still care when it wasn't novel?

Open source is a long-term commitment that most people underestimate.

## How This Applies to AI

The same principles hold with AI-generated code. The tool generates the implementation fast, but the hard work is still: defining the problem clearly, documenting the solution, maintaining it over time.
